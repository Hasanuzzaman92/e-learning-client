    ...
    return (
        <div className=''>
            <div className='px-4 text-center mb-5'>
                <h2 className='text-4xl font-bold'>Why choose {' '}
                 <span className='text-rose-400'>e-learning</span></h2>
            </div>
      ...
      <div className="grid row-gap-8 sm:row-gap-0 sm:grid-cols-2 lg:grid-cols-3">
        <div className="p-8 border-b sm:border-r">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Expert Instractor</h6>
        ...
        <div className="p-8 border-b lg:border-r">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Schedule learning</h6>
            <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="p-8 border-b sm:border-r lg:border-r-0">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Scholarship</h6>
            <p className="mb-3 text-sm text-gray-900">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem
              accusantium rem aperiam, eaque ipsa quae. Sit error voluptatem.
            </p>
        ...
        <div className="p-8 border-b lg:border-b-0 lg:border-r">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Recorded session</h6>
            <p className="mb-3 text-sm text-gray-900">
              Storage shed, troughs feed bale manure, is garden wheat oats at
              augers. Bulls at rose garden cucumbers mice sunflower wheat in
              pig.
        ...
        <div className="p-8 border-b sm:border-b-0 sm:border-r">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Practical project</h6>
            <p className="mb-3 text-sm text-gray-900">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem
              accusantium rem aperiam, eaque ipsa quae. Sit error voluptatem.
            </p>
